...
import {appendFormData, handleApiError, showSuccessAlert} from "@/hooks/admin/helpers";
...
const TabContent = ({data}) => {
    ...
    const onSubmit = useCallback(async (formData) => {
        ...
        try {
            const response = await postCaseSingle(submissionData);
            if (response.ok) {
        ...
        <>
            <div className={`${styles['admin-page-wrap']}`}>
                ...
                <CaseBlocks
                    ...
                    handleInputChange={handleUniqueChange}
                    formData={formData}
                    handleMediaInputChange={handleUniqueChange}
                />
                <AddNewSection
