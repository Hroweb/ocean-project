...
import {Tab1, Tab2, Tab3, Tab4} from "@/components/(Admin)/RightBar/services/tabs";
...
const TabContent = ({data, activeTab}) => {
    ...
    //const servicesData = data?.svList?.data;
    ...
    const initialFormData = {
        ...
        banner: {
            ...
            'page_title': pageMeta?.banner?.page_title?.meta_value ?? '',
        },
        collaborate: {
            'clb_title': pageMeta?.collaborate?.clb_title?.meta_value ?? '',
            'clb_text': pageMeta?.collaborate?.clb_text?.meta_value ?? '',
        },
        cases: {
            'ft_cases_title': pageMeta?.cases?.ft_cases_title?.meta_value ?? '',
            'ft_cases_btn_text': pageMeta?.cases?.ft_cases_btn_text?.meta_value ?? '',
        }
    };
    ...
    switch (activeTab) {
        ...
        case 'tab2':
            ...
            break;
        case 'tab3':
            tabContent = <Tab3 formData={formData.collaborate} handleInputChange={handleInputChange} subType={`collaborate`} />;
            break;
        case 'tab4':
            tabContent = <Tab4 formData={formData.cases} handleInputChange={handleInputChange} subType={`cases`} />;
            break;
        default:
            tabContent = null;
    }
